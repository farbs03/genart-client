                    ...
                    >
                        <div className="inline-block w-full max-w-sm p-6 my-8 overflow-hidden text-left align-middle transition-all transform bg-white shadow-xl rounded-2xl">
                            ...
                            <form onSubmit={submitRegister}>
                                ...
                                <div class="mt-4">
                                    <input className={classes.textfield} placeholder='Confirm Password' type="password" value={confirmPassword} onChange={(e) => setConfirmPassword(e.target.value)} />
                                </div>
                                
                                <div class="mt-6 mb-6 text-center">
                                    <p>Already have an account? <a class="text-green-500" style={{lineHeight: "20px"}} href="#">Login here</a></p>
                                    
                                </div>

                                <button onClick={onsubmit} className="bg-green-400 hover:bg-green-500 w-full transition duration-200 ease-in rounded text-center font-semibold py-2 text-white">Register</button>
                            </form>
